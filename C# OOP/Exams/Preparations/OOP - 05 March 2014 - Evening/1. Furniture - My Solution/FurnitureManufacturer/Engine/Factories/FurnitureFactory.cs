namespace FurnitureManufacturer.Engine.Factories
{
    ...
    public class FurnitureFactory : IFurnitureFactory
    {
        ...
        {
            return new Table(model, this.GetMaterialType(material), price, height, length, width);
        }

        public IChair CreateChair(string model, string material, decimal price, decimal height, int numberOfLegs)
        {
            return new Chair(model, this.GetMaterialType(material), price, height, numberOfLegs);
        }

        public IAdjustableChair CreateAdjustableChair(string model, string material, decimal price, decimal height, int numberOfLegs)
        {
            return new AdjustableChair(model, this.GetMaterialType(material), price, height, numberOfLegs);
        }
        ...
        {
            return new ConvertibleChair(model, this.GetMaterialType(material), price, height, numberOfLegs);
        }
